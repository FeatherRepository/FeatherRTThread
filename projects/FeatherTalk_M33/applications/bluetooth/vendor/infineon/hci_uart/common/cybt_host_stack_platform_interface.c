...
{
	/* SMP is intentionally optional. Treat a disabled adapter as a valid
	 * configuration; the previous WICED_ERROR default produced a misleading
	 * startup failure even though PatchRAM, HCI and the host stack were healthy. */
