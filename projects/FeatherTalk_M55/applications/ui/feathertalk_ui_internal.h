...
typedef struct
{
    ...
    uint32_t gpu_task_count;
    uint32_t sw_task_count;
    uint32_t gpu_tasks_per_second;
    uint32_t sw_tasks_per_second;
    uint32_t gpu_task_percent;
    uint32_t sw_label_tasks_per_second;
    uint32_t routed_gpu_task_count;
    uint32_t routed_sw_task_count;
    uint32_t route_unit_switch_count;
    uint32_t route_unit_switches_per_second;
    uint32_t gpu_submit_count;
    uint32_t gpu_submits_per_second;
    uint32_t gpu_submit_bytes_per_second;
    uint32_t gpu_flushes_per_second;
    uint32_t gpu_finishes_per_second;
    uint32_t gpu_finish_wait_ms_per_second;
    uint32_t gpu_finish_wait_max_ms;
    uint32_t gpu_busy_percent;
    uint32_t gpu_busy_average_percent;
    uint32_t gpu_busy_peak_percent;
    uint32_t gpu_busy_us_per_second;
    uint32_t gpu_busy_us_total;
    uint32_t gpu_completed_job_count;
    uint32_t gpu_jobs_per_second;
    uint32_t gpu_job_average_us;
    uint32_t gpu_job_average_total_us;
    uint32_t gpu_job_max_us;
} ft_ui_metrics_t;
