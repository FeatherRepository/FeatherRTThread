...
#define RT_SDIO_THREAD_PRIORITY 7
...
#define FEATHERTALK_USING_LVGL_GPU_BATCH
#define FEATHERTALK_LVGL_GPU_TRANSIENT_BYTES 196608
...
#define RT_CHERRYUSB_DEVICE_AUDIO
#define CONFIG_USBDEV_REQUEST_BUFFER_LEN 512
#define CONFIG_USBDEV_MSC_MAX_BUFSIZE 65536
#define RT_CHERRYUSB_DEVICE_TEMPLATE_NONE
/* FeatherTalk Wi-Fi: SDK demo baseline, firmware embedded (never FAL). */
...
#define RT_LWIP_IPADDR "0.0.0.0"
#define RT_LWIP_GWADDR "0.0.0.0"
#define RT_LWIP_MSKADDR "0.0.0.0"
#define RT_LWIP_UDP
#define RT_LWIP_TCP
#define RT_LWIP_RAW
...
#define CY_WIFI_INIT_THREAD_STACK_SIZE 4096
...
#define WHD_RESOURCES_IN_MEMORY
#define RT_WHD_LOG_LEVEL_ERROR
#define FEATHERTALK_USING_WIFI
